<?php
    ...
    if (isset($_GET['edit'])) {
        ...
        if (isset($_POST['name'])) {
            ...
            mysqli_query($conn, "UPDATE user SET id_level = '$id_level', name = '$name', email = '$email', password = '$password' WHERE id = '$id_user'");
        ...
        if (isset($_POST['name'])) {
            ...
            mysqli_query($conn, "INSERT INTO user (id_level, name, email, password) VALUES ('$id_level', '$name', '$email', '$password')");
