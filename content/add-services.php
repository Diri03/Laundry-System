<?php
    if (isset($_GET['edit'])) {
        ...
        if (isset($_POST['service_name'])) {
            ...
            mysqli_query($conn, "UPDATE type_of_service SET service_name = '$name', price = '$price', description = '$description' WHERE id = '$id_services'");
        ...
        if (isset($_POST['service_name'])) {
            ...
            $price = $_POST['price'];
            $description = $_POST['description'];
            mysqli_query($conn, "INSERT INTO type_of_service (service_name, price, description) VALUES ('$name', '$price', '$description')");
