<?php
    ...
    $queryUser = mysqli_query($conn, "SELECT user.name, level.level_name FROM user LEFT JOIN level ON user.id_level = level.id WHERE user.id = '$id_user'");
        ...
        <li class="nav-item navbar-dropdown dropdown-user dropdown">
            ...
            data-bs-toggle="dropdown">
                <div class="avatar avatar-online">
                    <img src="assets/assets/img/avatars/1.png" alt="alt" class="rounded-circle" />
                </div>
            </a>
                    ...
                    <a class="dropdown-item" href="#">
                        <div class="d-flex">
                            <div class="flex-shrink-0 me-3">
                                <div class="avatar avatar-online">
                                    <img src="assets/assets/img/avatars/1.png" alt="alt" class="w-px-40 h-auto rounded-circle" />
                                </div>
                            </div>
